...
require 'conn.php';
require 'tracker.php';
$hero_culture = mysqli_fetch_assoc(mysqli_query($conn, "SELECT image_url FROM images_hero WHERE page='culture'"))['image_url'] ?? 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1400';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <style>
    ...
    .hero { background: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.65)), url("<?php echo htmlspecialchars($hero_culture); ?>") center/cover no-repeat; color: white; padding: 60px 30px; text-align: center; }
    ...
    .grid > * { flex: 1 1 300px; max-width: 380px; }
