...
require 'conn.php';
require 'tracker.php';
$hero_accueil = mysqli_fetch_assoc(mysqli_query($conn, "SELECT image_url FROM images_hero WHERE page='accueil'"))['image_url'] ?? 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=1400';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .hero { background: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.65)), url("<?php echo htmlspecialchars($hero_accueil); ?>") center/cover no-repeat; color: white; padding: 80px 30px; text-align: center; }
