...
require 'conn.php';
require 'tracker.php';
$hero_apropos = mysqli_fetch_assoc(mysqli_query($conn, "SELECT image_url FROM images_hero WHERE page='apropos'"))['image_url'] ?? 'https://images.unsplash.com/photo-1524661135-423995f22d0b?w=1400';
?>
<!DOCTYPE html>
<html lang="fr">
<head>
  ...
  <style>
    ...
    .hero { background: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.65)), url("<?php echo htmlspecialchars($hero_apropos); ?>") center/cover no-repeat; color: white; padding: 60px 30px; text-align: center; }
